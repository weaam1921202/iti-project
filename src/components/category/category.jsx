      ...
      <div className="row g-4 justify-content-center p-4">
        <div className="card col-lg-3 col-md-6 col-sm-12 border-0 shadow-sm">
          <div className="details d-flex flex-column align-items-center justify-content-center p-4">
            <i className="icons fa-solid fa-check text-warning fs-2 mb-2"></i>
        ...
        <div className="card col-lg-3 col-md-6 col-sm-12 border-0 shadow-sm">
          <div className="details d-flex flex-column align-items-center justify-content-center p-4">
            <i className="icons fa-solid fa-truck text-warning fs-2 mb-2"></i>
        ...
        <div className="card col-lg-3 col-md-6 col-sm-12 border-0 shadow-sm">
          <div className="details d-flex flex-column align-items-center justify-content-center p-4">
            <i className="icons fa-solid fa-rotate-left text-warning fs-2 mb-2"></i>
        ...
        <div className="card col-lg-3 col-md-6 col-sm-12 border-0 shadow-sm">
          <div className="details d-flex flex-column align-items-center justify-content-center p-4">
            <i className="icons fa-solid fa-headset text-warning fs-2 mb-2"></i>
