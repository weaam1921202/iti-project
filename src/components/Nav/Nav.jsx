...
>>>>>>> 7d34715afa1c6e9377ae210d96ad22affb3fba17
              ...
              <ul className="dropdown-menu">
                <li>
                  <NavLink to={"/fake"} className="dropdown-item">
                    Fake API
                  </NavLink>
                </li>
                <li>
                  <NavLink to={"/dummy"} className="dropdown-item">
                    Dummy API
                  </NavLink>
                </li>
              </ul>
            ...
            <li className="nav-item ms-3 fs-2" onClick={darkmood}>
              {dark ? (
                <i className="fa-solid fa-sun mood"></i>
              ) : (
                <i className="fa-solid fa-moon mood" />
              )}
            </li>
          </ul>
            ...
            {user ? (
              <div className="fs-5 icon-login" style={{ cursor: "pointer" }}>
                <span onClick={handleLogout}>
                  ...
                  ></i>
                  <span className="span-login">Logout</span>
                </span>
                ...
                <span style={{ marginLeft: "7px" }}>
                  Hello, <span className="span-user">{user.fullName}</span>
                </span>
              </div>
            ) : (
              <Link to="/Login" className="fs-5 icon-login">
                <i className="fa-solid fa-right-to-bracket"></i>
                <span className="span-login">Login</span>
                <span style={{ marginLeft: "7px" }}>
                  Hello,<span className="span-user">Guest</span>
                </span>
              </Link>
            )}
=======
